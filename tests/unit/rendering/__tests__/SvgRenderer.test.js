...
describe('SvgRenderer', () => {
  ...
  beforeEach(async () => {
    ...
    mockAvatarRenderer = vi.mocked(
      await import('../../../../src/rendering/components/AvatarRenderer.js')
    ).default
    mockReactionRenderer = vi.mocked(
      await import('../../../../src/rendering/components/ReactionRenderer.js')
    ).default
    mockChartRenderer = vi.mocked(
      await import('../../../../src/rendering/components/ChartRenderer.js')
    ).default
    mockScrollAnimationEngine = vi.mocked(
      await import('../../../../src/rendering/ScrollAnimationEngine.js')
    ).default
  })
  ...
  describe('renderSVG', () => {
    it('should render complete SVG with typing indicator and chat messages', () => {
      ...
      expect(mockChartRenderer.render).toHaveBeenCalledWith(
        chartMessage,
        expect.any(Object),
        expect.any(String)
      )
      expect(mockReactionRenderer.render).toHaveBeenCalledWith(
        chartMessage,
        expect.any(Object),
        expect.any(Number),
        false
