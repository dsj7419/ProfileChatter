...
describe('GitHubOAuthService', () => {
  ...
  describe('exchangeCodeForTokens', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(githubOAuthService.exchangeCodeForTokens('bad-code')).rejects.toThrow(
  ...
  describe('refreshAccessToken', () => {
    it('should throw error as GitHub does not support refresh', async () => {
      await expect(githubOAuthService.refreshAccessToken()).rejects.toThrow(
  ...
  describe('getAccessToken', () => {
    ...
    it('should throw when no token available', async () => {
      ...
      await expect(githubOAuthService.getAccessToken()).rejects.toThrow(
