...
describe('SpotifyOAuthService', () => {
  ...
  describe('getAuthorizationUrl', () => {
    it('should generate correct authorization URL', () => {
      ...
      expect(urlObj.searchParams.get('scope')).toBe('user-read-currently-playing user-read-recently-played');
    });
  ...
  describe('exchangeCodeForTokens', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        spotifyOAuthService.exchangeCodeForTokens('bad-code')
      ).rejects.toThrow('Spotify API error: 400 Bad Request - Invalid code');
    });
  ...
  describe('refreshAccessToken', () => {
    ...
    it('should handle missing credentials', async () => {
      ...
      await expect(
        spotifyOAuthService.refreshAccessToken(true)
      ).rejects.toThrow('Missing required Spotify credentials');
    });
    ...
    it('should handle refresh errors', async () => {
      ...
      await expect(
        spotifyOAuthService.refreshAccessToken()
      ).rejects.toThrow('Spotify API error: 401 Unauthorized - Invalid refresh token');
    });
  });
  ...
  describe('getAccessToken', () => {
    ...
    it('should throw when no tokens available', async () => {
      ...
      ).rejects.toThrow('No valid Spotify tokens available');
    });
  });
});