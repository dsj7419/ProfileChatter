...
![ProfileChatter Demo](https://raw.githubusercontent.com/dsj7419/ProfileChatter/main/dist/profile-chat.svg?ts=1782478079)
...
3. **Embed the badge** in your profile README — the special repo named after your username (`<you>/<you>`):
   ...
   ```markdown
   ![My Profile Chat](https://raw.githubusercontent.com/<you>/ProfileChatter/main/dist/profile-chat.svg?ts=1782478079)
   ```
