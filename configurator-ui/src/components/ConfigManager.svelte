<script>
    ...
    async function copyConfigForGitHub() {
      try {
        ...
        showStatusMessage('Configuration copied to clipboard! Follow the instructions below to update GitHub.');
        
        // Show GitHub instructions
        showGitHubInstructions = true;
      } catch (err) {
        console.error('Error copying configuration to clipboard:', err);
        showStatusMessage('Failed to copy to clipboard. Please try downloading the file instead.', true);
      }
    }
    ...
    function importThemeSettings(data) {
      ...
      const requiredThemeProperties = [
        'ME_BUBBLE_COLOR', 'VISITOR_BUBBLE_COLOR', 
        'ME_TEXT_COLOR', 'VISITOR_TEXT_COLOR'
      ];
    ...
    function importProfileData(data) {
      ...
      if (!workDate || typeof workDate !== 'object' || 
    ...
    function importAvatarSettings(data) {
      ...
      if (!avatarData.me || typeof avatarData.me !== 'object' ||
          !avatarData.visitor || typeof avatarData.visitor !== 'object') {
        showStatusMessage('Invalid avatar settings. Missing or invalid "me" or "visitor" properties.', true);
        return false;
      }
  ...
  <div class="p-3 border border-gray-200 rounded-md bg-white">
    ...
    <div class="space-y-3">
      ...
      {#if showGitHubInstructions}
        <div class="mt-4 p-4 border border-blue-200 rounded-md bg-blue-50 transition-all" transition:slide={{ duration: 300 }}>
          <div class="flex justify-between items-start mb-2">
            <h4 class="text-sm font-medium text-blue-800">How to Update Your Profile SVG on GitHub:</h4>
            <button 
              type="button" 
          ...
          <ol class="list-decimal pl-5 space-y-2 text-sm text-gray-700">
            <li><strong>Configuration Copied:</strong> The content for your <code class="bg-blue-100 px-1 rounded">profileChatterConfig.json</code> file has been copied to your clipboard.</li>
            
            <li><strong>Go to Your Repository:</strong> Open your forked ProfileChatter repository on GitHub.
              <br><span class="text-xs text-gray-500">(e.g., https://github.com/YOUR_USERNAME/ProfileChatter)</span>
            </li>
            
            <li><strong>Edit/Create 'profileChatterConfig.json':</strong>
              <ul class="list-disc pl-5 mt-1 text-xs">
                <li>If <code class="bg-blue-100 px-1 rounded">profileChatterConfig.json</code> already exists at the root of your repository, click on it, then click the 'Edit this file' (pencil) icon.</li>
                <li>If it doesn't exist, click 'Add file' -> 'Create new file'. Name the new file <code class="bg-blue-100 px-1 rounded">profileChatterConfig.json</code>.</li>
              </ul>
            </li>
            
            <li><strong>Paste Content:</strong> Delete all existing content in the file editor (if any) and paste (Ctrl+V or Cmd+V) the configuration from your clipboard.</li>
            ...
            <li><strong>Auto-Update:</strong> The GitHub Action in your repository will automatically run, rebuild your SVG with the new settings, and update your profile README link. This may take a few minutes.</li>
          </ol>
      ...
      <div class="pt-2 mt-2 border-t border-gray-200">
        <h4 class="text-xs font-medium text-gray-500 uppercase mb-2">Export Specific Parts</h4>
        <div class="grid grid-cols-2 gap-2">
          ...
          >
            <svg class="w-3 h-3 mr-1 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
            </svg>
          ...
          <div class="flex flex-col space-y-2">
            ...
            >
              ...
              {:else}
                ...
                <svg class="w-4 h-4 mr-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
              <h5 class="text-xs font-medium text-gray-500 uppercase mb-2">Import Specific Part</h5>
